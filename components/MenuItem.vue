...
<template>
  <div class="flex items-center justify-center p-4">
    <NuxtLink :to="props.to"
      class="relative flex h-full w-full flex-col items-stretch gap-1 outline-none transition hover:scale-105 focus:scale-105 active:scale-100 [&_h2]:focus:font-extrabold [&_h2]:hover:font-extrabold [&_#cov]:hover:scale-105 [&_#cov]:focus:scale-105 [&_#tb]:hover:bg-focus [&_#tb]:focus:bg-focus [&_header]:hover:bg-focus/50 [&_header]:focus:bg-focus/focus-opacity">
